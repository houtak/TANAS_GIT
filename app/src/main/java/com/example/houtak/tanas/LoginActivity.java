    ...
    private void sendPassword(final String forgotemail) {
        class SendPassword extends AsyncTask<Void,String,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest("http://wht0912.000webhostapp.com/tanas/php/verify_email.php",hashMap);
                Log.d("haha",s);
                return s;
            }
            @Override
        ...
        class LoginUser extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                ...
                loading = ProgressDialog.show(LoginActivity.this,
                        "Login user","Loading...",false,false);
            }
            @Override
            protected String doInBackground(Void... voids) {
                HashMap<String,String> hashMap = new HashMap<>();
                ...
                String s = rh.sendPostRequest
                        ("http://wht0912.000webhostapp.com/tanas/php/login.php",hashMap);
                Log.d("haha",s);
                return s;
            }
