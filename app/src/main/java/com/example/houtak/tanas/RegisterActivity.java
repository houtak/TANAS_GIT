...
//Spinner sploc;
EditText edEmail,edPass,edPhone,edName,edlastName;
Button btnReg;
...
ImageButton btnmapwindown;
    ...
    private void registerUserInput() {
        String email,pass,phone,name,lastname;
        ...
        //error checking here
        user = new User(name,phone,email,pass,lastname,hlatitude,hlongitude);
        //insertData(user);
        registerUserDialog();
    }
    ...
    private void insertData() {
            class RegisterUser extends AsyncTask<Void,Void,String>{
                ...
                protected String doInBackground(Void... voids) {
                    ...
                    hashMap.put("fname",user.name);
                    hashMap.put("lname",user.lastname);
                    hashMap.put("latitude",user.latitude);
                    hashMap.put("longitude",user.longitude);
                    RequestHandler rh = new RequestHandler();
                    String s = rh.sendPostRequest
                            ("http://wht0912.000webhostapp.com/tanas/php/insert_registration.php",hashMap);
                    return s;
                }
        ...
        private void makeRequest(final String encoded_string, final String image_name) {
            class UploadAll extends AsyncTask<Void, Void, String> {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    String s = rh.sendPostRequest("http://wht0912.000webhostapp.com/tanas/php/upload_image.php", map);
                    return s;
                }
